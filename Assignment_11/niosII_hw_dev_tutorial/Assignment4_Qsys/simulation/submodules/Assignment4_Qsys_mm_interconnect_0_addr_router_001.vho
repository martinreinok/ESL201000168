...
--synthesis_resources = mux21 38 
 ...
 ARCHITECTURE RTL OF Assignment4_Qsys_mm_interconnect_0_addr_router_001 IS
	 ...
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_14m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_19m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_25m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_30m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_36m_dataout	:	STD_LOGIC;
	 ...
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_21m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_23m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_32m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_34m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_43m_dataout	:	STD_LOGIC;
	 ...
	 SIGNAL  wire_w_lg_w_sink_data_range122w345w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_w_sink_data_range128w319w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_w_sink_data_range146w308w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_w_sink_data_range158w307w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w1w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w2w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_w_sink_data_range125w331w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_w_sink_data_range131w285w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_w_sink_data_range149w297w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_w_sink_data_range161w305w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_0_310_dataout :	STD_LOGIC;
	 ...
	 SIGNAL  wire_w_sink_data_range161w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
 BEGIN

	wire_w_lg_w_sink_data_range122w345w(0) <= wire_w_sink_data_range122w(0) AND wire_w_lg_w_sink_data_range125w331w(0);
	wire_w_lg_w_sink_data_range128w319w(0) <= wire_w_sink_data_range128w(0) AND wire_w_lg_w_sink_data_range131w285w(0);
	wire_w_lg_w_sink_data_range146w308w(0) <= wire_w_sink_data_range146w(0) AND wire_w_lg_w_sink_data_range149w297w(0);
	wire_w_lg_w_sink_data_range158w307w(0) <= wire_w_sink_data_range158w(0) AND wire_w_lg_w_sink_data_range161w305w(0);
	wire_w1w(0) <= NOT s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_0_310_dataout;
	wire_w2w(0) <= NOT s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_2_346_dataout;
	wire_w_lg_w_sink_data_range125w331w(0) <= NOT wire_w_sink_data_range125w(0);
	wire_w_lg_w_sink_data_range131w285w(0) <= NOT wire_w_sink_data_range131w(0);
	wire_w_lg_w_sink_data_range149w297w(0) <= NOT wire_w_sink_data_range149w(0);
	wire_w_lg_w_sink_data_range161w305w(0) <= NOT wire_w_sink_data_range161w(0);
	s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_always1_0_400_dataout <= ((((((((((((((NOT sink_data(39)) AND wire_w_lg_w_sink_data_range125w331w(0)) AND (NOT sink_data(41))) AND sink_data(42)) AND (NOT sink_data(43))) AND (NOT sink_data(44))) AND (NOT sink_data(45))) AND sink_data(46)) AND (NOT sink_data(47))) AND sink_data(48)) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND (NOT sink_data(51))) AND sink_data(52));
	...
	s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_0_310_dataout <= ((((((((((((NOT sink_data(41)) AND wire_w_lg_w_sink_data_range131w285w(0)) AND (NOT sink_data(43))) AND (NOT sink_data(44))) AND (NOT sink_data(45))) AND (NOT sink_data(46))) AND (NOT sink_data(47))) AND wire_w_lg_w_sink_data_range149w297w(0)) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND (NOT sink_data(51))) AND wire_w_lg_w_sink_data_range161w305w(0));
	s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_1_328_dataout <= wire_w_lg_w_sink_data_range158w307w(0);
	s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_2_346_dataout <= ((((wire_w_lg_w_sink_data_range146w308w(0) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND (NOT sink_data(51))) AND sink_data(52));
	s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_3_364_dataout <= (((((((NOT sink_data(46)) AND (NOT sink_data(47))) AND sink_data(48)) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND (NOT sink_data(51))) AND sink_data(52));
	s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_4_382_dataout <= ((((((((((wire_w_lg_w_sink_data_range128w319w(0) AND (NOT sink_data(43))) AND (NOT sink_data(44))) AND (NOT sink_data(45))) AND sink_data(46)) AND (NOT sink_data(47))) AND sink_data(48)) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND (NOT sink_data(51))) AND sink_data(52));
	s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_5_418_dataout <= ((((((((((((wire_w_lg_w_sink_data_range122w345w(0) AND (NOT sink_data(41))) AND sink_data(42)) AND (NOT sink_data(43))) AND (NOT sink_data(44))) AND (NOT sink_data(45))) AND sink_data(46)) AND (NOT sink_data(47))) AND sink_data(48)) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND (NOT sink_data(51))) AND sink_data(52));
	...
	wire_w_sink_data_range128w(0) <= sink_data(41);
	...
	wire_w_sink_data_range161w(0) <= sink_data(52);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_14m_dataout <= s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_0_310_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_1_328_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_19m_dataout <= wire_w1w(0) OR s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_1_328_dataout;
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_25m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_14m_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_2_346_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_30m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_19m_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_2_346_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_36m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_25m_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_3_364_dataout);
	...
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_42m_dataout <= s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_2_346_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_3_364_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_47m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_36m_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_4_382_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_48m_dataout <= s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_3_364_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_4_382_dataout);
	...
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_21m_dataout <= s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_0_310_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_1_328_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_23m_dataout <= wire_w1w(0) OR s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_1_328_dataout;
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_32m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_21m_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_2_346_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_34m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_23m_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_2_346_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_43m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_32m_dataout AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_3_364_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_44m_dataout <= wire_w2w(0) AND NOT(s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_3_364_dataout);
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_45m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_34m_dataout OR s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_3_364_dataout;
	wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_54m_dataout <= wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_data_43m_dataout OR s_wire_assignment4_qsys_mm_interconnect_0_addr_router_001_src_channel_4_382_dataout;
