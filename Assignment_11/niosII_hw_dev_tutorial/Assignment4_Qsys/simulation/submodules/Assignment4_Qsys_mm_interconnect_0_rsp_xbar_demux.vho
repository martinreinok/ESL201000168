...
--synthesis_resources = 
 ...
 ENTITY  Assignment4_Qsys_mm_interconnect_0_rsp_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END Assignment4_Qsys_mm_interconnect_0_rsp_xbar_demux;

 ARCHITECTURE RTL OF Assignment4_Qsys_mm_interconnect_0_rsp_xbar_demux IS
 ...
 END RTL; --Assignment4_Qsys_mm_interconnect_0_rsp_xbar_demux
