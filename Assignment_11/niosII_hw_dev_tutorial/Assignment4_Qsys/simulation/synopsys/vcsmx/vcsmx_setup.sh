...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/assignment4_qsys_mm_interconnect_0_uart_0_s1_translator.vhd"                                                     -work mm_interconnect_0                                                       
  ...
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/Assignment4_Qsys_uart_0.vhd"                                                                                     -work uart_0                                                                  
  ...
  vhdlan -xlrm          "$QSYS_SIMDIR/submodules/PWMController.vhd"                                                                                               -work esl_bus_demo_0                                                          
