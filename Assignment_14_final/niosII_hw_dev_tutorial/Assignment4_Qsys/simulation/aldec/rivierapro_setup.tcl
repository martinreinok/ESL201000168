...
# ACDS 13.1 162 linux 2023.06.28.16:12:29
...
alias com {
  ...
  vcom  "$QSYS_SIMDIR/submodules/assignment4_qsys_mm_interconnect_0_uart_0_s1_translator.vhd"                                                     -work mm_interconnect_0                                                       
  ...
  vcom  "$QSYS_SIMDIR/submodules/Assignment4_Qsys_uart_0.vhd"                                                                                     -work uart_0                                                                  
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L rsp_xbar_demux -L cmd_xbar_mux_002 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L limiter -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L esl_bus_demo_0_s0_translator_avalon_universal_slave_0_agent_rsp_fifo -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent -L cpu_instruction_master_translator_avalon_universal_master_0_agent -L cpu_jtag_debug_module_translator -L cpu_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L uart_0 -L esl_bus_demo_0 -L sysid -L sys_clk_timer -L jtag_uart -L cpu -L onchip_mem -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L rsp_xbar_demux -L cmd_xbar_mux_002 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L limiter -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L esl_bus_demo_0_s0_translator_avalon_universal_slave_0_agent_rsp_fifo -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent -L cpu_instruction_master_translator_avalon_universal_master_0_agent -L cpu_jtag_debug_module_translator -L cpu_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L uart_0 -L esl_bus_demo_0 -L sysid -L sys_clk_timer -L jtag_uart -L cpu -L onchip_mem -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
