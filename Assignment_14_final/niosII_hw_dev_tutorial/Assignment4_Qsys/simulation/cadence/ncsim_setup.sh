...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/assignment4_qsys_mm_interconnect_0_uart_0_s1_translator.vhd"                                                     -work mm_interconnect_0                                                        -cdslib ./cds_libs/mm_interconnect_0.cds.lib                                                       
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/Assignment4_Qsys_uart_0.vhd"                                                                                     -work uart_0                                                                   -cdslib ./cds_libs/uart_0.cds.lib                                                                  
