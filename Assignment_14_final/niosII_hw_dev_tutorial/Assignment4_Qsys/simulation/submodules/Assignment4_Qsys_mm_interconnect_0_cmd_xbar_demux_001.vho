...
--synthesis_resources = 
 ...
 ENTITY  Assignment4_Qsys_mm_interconnect_0_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END Assignment4_Qsys_mm_interconnect_0_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF Assignment4_Qsys_mm_interconnect_0_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_assignment4_qsys_mm_interconnect_0_cmd_xbar_demux_001_wideor0_15_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_assignment4_qsys_mm_interconnect_0_cmd_xbar_demux_001_wideor0_15_dataout <= ((((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0)) OR wire_w_lg_w_sink_channel_range18w19w(0));
	sink_ready <= s_wire_assignment4_qsys_mm_interconnect_0_cmd_xbar_demux_001_wideor0_15_dataout;
 ...
 END RTL; --Assignment4_Qsys_mm_interconnect_0_cmd_xbar_demux_001
