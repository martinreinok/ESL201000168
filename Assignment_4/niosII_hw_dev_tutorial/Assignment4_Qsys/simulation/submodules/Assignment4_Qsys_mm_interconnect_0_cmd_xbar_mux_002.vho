...
--synthesis_resources = 
 ...
 ENTITY  Assignment4_Qsys_mm_interconnect_0_cmd_xbar_mux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END Assignment4_Qsys_mm_interconnect_0_cmd_xbar_mux_002;

 ARCHITECTURE RTL OF Assignment4_Qsys_mm_interconnect_0_cmd_xbar_mux_002 IS
